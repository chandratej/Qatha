...
export type StudioStringKey =
  ...
  | 'createStory.coverDefaultUntilPublish'
  | 'createStory.coverOptionalAtCreate'
  ...
  | 'epistolaryEditor.castHintShort'
  ...
  | 'epistolaryEditor.chapterTitlePlaceholder'
  ...
  | 'epistolaryEditor.publishSuccess'
  | 'epistolaryEditor.publishError'
  | 'epistolaryEditor.publishEmpty'
  | 'epistolaryEditor.scenesLabel'
  | 'epistolaryEditor.sceneTitle'
  | 'epistolaryEditor.addScene'
  | 'epistolaryEditor.removeScene'
  | 'epistolaryEditor.emptyScene'
  | 'epistolaryEditor.deleteCastTitle'
  | 'epistolaryEditor.deleteCastBody'
  | 'epistolaryEditor.deleteCastConfirm'
  | 'epistolaryEditor.deleteCastCancel'
...
const STRINGS: Record<StudioLocale, StudioStrings> = {
  te: {
    ...
    'createStory.coverHint': 'ఇప్పుడు ఐచ్ఛికం — ప్రచురణకు ముందు తప్పనిసరి. 600×900 (2:3), JPG/PNG 1MB లోపు.',
    ...
    'createStory.coverRequired': 'ప్రచురించే ముందు నిజమైన కవర్ చిత్రం తప్పనిసరి.',
    ...
    'createStory.submitHint': 'శీర్షిక తప్పనిసరి — కవర్ ప్రచురణకు ముందు జోడించండి.',
    ...
    'createStory.coverDefaultUntilPublish': 'డిఫాల్ట్ కవర్ (ప్రచురణకు ముందు మార్చండి)',
    'createStory.coverOptionalAtCreate': 'కవర్ ఇప్పుడు అవసరం లేదు — డిఫాల్ట్ వాడబడుతుంది',
    ...
    'epistolaryEditor.badge': 'చాట్ కథ',
    'epistolaryEditor.back': 'గ్రంధానికి వెనక్కి',
    'epistolaryEditor.addMessage': 'సందేశం',
    'epistolaryEditor.scaffoldHint': 'చాట్-బబుల్ ఎడిటర్',
    'epistolaryEditor.messagePlaceholder': 'సందేశం రాయండి…',
    'epistolaryEditor.speakerName': 'పాత్ర పేరు',
    'epistolaryEditor.speakerRole': 'పాత్ర రకం',
    ...
    'epistolaryEditor.roleNarrator': 'కథకుడు',
    'epistolaryEditor.threadLabel': 'సంభాషణ',
    'epistolaryEditor.messageCount': 'సందేశాలు',
    'epistolaryEditor.castTitle': 'పాత్రలు',
    'epistolaryEditor.castHint': 'పేర్లు ఒక్కసారి — తెలుగు లేదా ఆంగ్లం. సందేశంలో ఎంచుకుంటే పేరు స్వయంగా వస్తుంది.',
    'epistolaryEditor.castHintShort': 'పేరు ఒక్కసారి రాయండి · ఎన్ని నాయకులు / విరోధులు కావాలంటే అన్ని',
    'epistolaryEditor.castCount': 'పాత్రలు',
    'epistolaryEditor.addCastMember': 'పాత్ర',
    'epistolaryEditor.removeCastMember': 'పాత్రను తొలగించు',
    'epistolaryEditor.castEmptyRole': 'ఇంకా ఎవరూ లేరు',
    'epistolaryEditor.selectCharacter': 'ఎవరు మాట్లాడుతున్నారు',
    'epistolaryEditor.nameFromCast': 'పేరు పైన మార్చండి — అన్ని సందేశాలకు వర్తిస్తుంది',
    ...
    'epistolaryEditor.publishEmpty': 'ప్రచురించడానికి కనీసం ఒక సందేశం రాయండి',
    'epistolaryEditor.scenesLabel': 'సీన్లు',
    'epistolaryEditor.sceneTitle': 'సీన్ పేరు',
    'epistolaryEditor.addScene': 'సీన్',
    'epistolaryEditor.removeScene': 'సీన్ తొలగించు',
    'epistolaryEditor.emptyScene': 'ఈ సీన్‌లో ఇంకా సందేశాలు లేవు — కింద రాయండి.',
    'epistolaryEditor.deleteCastTitle': 'పాత్రను తొలగించాలా?',
    'epistolaryEditor.deleteCastBody': '“{name}” ను తొలగిస్తే వారి {count} సందేశాలు కూడా తొలగించబడతాయి. కొనసాగాలా?',
    'epistolaryEditor.deleteCastConfirm': 'పాత్ర + సందేశాలు తొలగించు',
    'epistolaryEditor.deleteCastCancel': 'రద్దు',
    'epistolaryEditor.quickAdd': 'త్వరిత సందేశం',
    'epistolaryEditor.saveDraft': 'సేవ్',
    'epistolaryEditor.saving': 'సేవ్…',
    'epistolaryEditor.savedPrefix': 'సేవ్',
    'epistolaryEditor.cloudSyncing': 'సేవ్ అవుతోంది…',
    'epistolaryEditor.cloudSynced': 'సేవ్ అయింది',
    'epistolaryEditor.cloudPending': 'స్థానిక డ్రాఫ్ట్',
    'epistolaryEditor.cloudError': 'సేవ్ విఫలం',
    'epistolaryEditor.persistHint': 'ఆటో-సేవ్ ఆన్.',
  ...
  en: {
    ...
    'createStory.coverHint': 'Optional now — required before publish. 600×900 (2:3), JPG/PNG under 1MB.',
    ...
    'createStory.coverRequired': 'A real cover image is required before publishing.',
    ...
    'createStory.submitHint': 'Title required — cover can wait until publish.',
    ...
    'createStory.coverDefaultUntilPublish': 'Default cover (change before publish)',
    'createStory.coverOptionalAtCreate': 'Cover not required now — default will be used',
    ...
    'epistolaryEditor.badge': 'Chat story',
    'epistolaryEditor.back': 'Back to manuscript',
    'epistolaryEditor.addMessage': 'Message',
    'epistolaryEditor.scaffoldHint': 'Chat-bubble editor',
    'epistolaryEditor.messagePlaceholder': 'Write the message…',
    'epistolaryEditor.speakerName': 'Character name',
    'epistolaryEditor.speakerRole': 'Role',
    ...
    'epistolaryEditor.threadLabel': 'Conversation',
    'epistolaryEditor.messageCount': 'messages',
    'epistolaryEditor.castTitle': 'Characters',
    'epistolaryEditor.castHint': 'Name once in Telugu or English. Select on a message — name fills in.',
    'epistolaryEditor.castHintShort': 'Name once · as many protagonists or antagonists as you need',
    'epistolaryEditor.castCount': 'characters',
    'epistolaryEditor.addCastMember': 'Character',
    'epistolaryEditor.removeCastMember': 'Remove character',
    'epistolaryEditor.castEmptyRole': 'None yet',
    'epistolaryEditor.selectCharacter': 'Who is speaking',
    'epistolaryEditor.nameFromCast': 'Edit the name above — it updates every message',
    ...
    'epistolaryEditor.publishEmpty': 'Write at least one message before publishing',
    'epistolaryEditor.scenesLabel': 'Scenes',
    'epistolaryEditor.sceneTitle': 'Scene title',
    'epistolaryEditor.addScene': 'Scene',
    'epistolaryEditor.removeScene': 'Remove scene',
    'epistolaryEditor.emptyScene': 'No messages in this scene yet — write below.',
    'epistolaryEditor.deleteCastTitle': 'Remove this character?',
    'epistolaryEditor.deleteCastBody': 'Removing “{name}” will also delete their {count} messages. Continue?',
    'epistolaryEditor.deleteCastConfirm': 'Remove character & messages',
    'epistolaryEditor.deleteCastCancel': 'Cancel',
    'epistolaryEditor.quickAdd': 'Quick message as',
    'epistolaryEditor.saveDraft': 'Save',
    'epistolaryEditor.saving': 'Saving…',
    'epistolaryEditor.savedPrefix': 'Saved',
    'epistolaryEditor.cloudSyncing': 'Saving…',
    'epistolaryEditor.cloudSynced': 'Saved',
    'epistolaryEditor.cloudPending': 'Local draft',
    'epistolaryEditor.cloudError': 'Save failed',
    'epistolaryEditor.persistHint': 'Auto-save is on.',
