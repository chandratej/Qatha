...
$map = [ordered]@{
  ...
  ALLOWED_ORIGINS              = "http://localhost:5173,http://127.0.0.1:5173,https://katha-creator-cms.vercel.app,https://katha-landing-psi.vercel.app,https://gateway-qatha.vercel.app,https://studio.katha.in,https://katha.app"
