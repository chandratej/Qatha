...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      await ref.read(loginProvider((email: _emailController.text.trim(), password: _passwordController.text)));
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Sign in to continue reading', style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: Colors.grey)),
